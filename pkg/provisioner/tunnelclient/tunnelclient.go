...
func Dial(ctx context.Context, baseURL string, rt http.RoundTripper, port int) (net.Conn, error) {
	...
	if err != nil {
		// TODO(ai-review): match on hostmux's JSON "port_unreachable" code, not bare 502, so an intermediary's unrelated 502 isn't misclassified. https://github.com/supaclank/clank/pull/125
