...
func TestPreferences_RoundTrip(t *testing.T) {
	...
	if got.WebPreviewLauncherSeen != want.WebPreviewLauncherSeen {
		t.Errorf("WebPreviewLauncherSeen: got %t, want %t", got.WebPreviewLauncherSeen, want.WebPreviewLauncherSeen)
	}
