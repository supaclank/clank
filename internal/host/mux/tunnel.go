...
func (m *Mux) handleTunnel(w http.ResponseWriter, r *http.Request) {
	...
	// TODO(ai-review): dial "localhost" instead of the IPv4 literal so an ::1-only dev server is reachable too. https://github.com/supaclank/clank/pull/125#discussion_r3565157117
