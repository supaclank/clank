...
(() => {
  ...
  const ICONS = {
    ...
    launcher: '<svg width="27" height="27" viewBox="0 0 24 24" fill="none" aria-hidden="true"><defs><linearGradient id="clank-mark" x1="2" y1="2" x2="22" y2="22"><stop stop-color="#ff315f"/><stop offset="1" stop-color="#ff4f83"/></linearGradient></defs><rect class="launcher-mark-field" x="5" y="5" width="14" height="14" fill="url(#clank-mark)" opacity=".48"/><rect class="launcher-mark-dash" x="8" y="4.125" width="3.25" height="1.75" fill="url(#clank-mark)"/><rect class="launcher-mark-dash" x="12.75" y="4.125" width="3.25" height="1.75" fill="url(#clank-mark)"/><rect class="launcher-mark-dash" x="8" y="18.125" width="3.25" height="1.75" fill="url(#clank-mark)"/><rect class="launcher-mark-dash" x="12.75" y="18.125" width="3.25" height="1.75" fill="url(#clank-mark)"/><rect class="launcher-mark-dash" x="4.125" y="8" width="1.75" height="3.25" fill="url(#clank-mark)"/><rect class="launcher-mark-dash" x="4.125" y="12.75" width="1.75" height="3.25" fill="url(#clank-mark)"/><rect class="launcher-mark-dash" x="18.125" y="8" width="1.75" height="3.25" fill="url(#clank-mark)"/><rect class="launcher-mark-dash" x="18.125" y="12.75" width="1.75" height="3.25" fill="url(#clank-mark)"/><rect class="launcher-mark-corner" x="2" y="2" width="5.5" height="5.5" fill="url(#clank-mark)"/><rect class="launcher-mark-corner" x="16.5" y="2" width="5.5" height="5.5" fill="url(#clank-mark)"/><rect class="launcher-mark-corner" x="16.5" y="16.5" width="5.5" height="5.5" fill="url(#clank-mark)"/><rect class="launcher-mark-corner" x="2" y="16.5" width="5.5" height="5.5" fill="url(#clank-mark)"/></svg>',
  };
