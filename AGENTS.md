...
## Naming
1. Boolean fields should normally be phrased as an affirmative statement that evaluates to either true or false. Prefixes: Is, Has, Can, Should, Must, etc. Evaulate on a case by case basis though.
